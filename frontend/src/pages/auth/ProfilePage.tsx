import { LockOutlined, SaveOutlined, UserOutlined, MailOutlined, IdcardOutlined } from "@ant-design/icons";
import { Avatar, Button, Card, Col, Descriptions, Divider, Form, Modal, Row, Typography } from "antd";
            ...
            <main className="content fade-in">
                            ...
                            >
                                <div style={{
                                    ...
                                    <div>
                                        ...
                                        <Text type="secondary" style={{ fontSize: '1.2rem', display: 'block', marginTop: '4px' }}>
                                            {profileData?.role}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <Descriptions.Item label={<span><IdcardOutlined /> Username</span>}>
                ...
                >
                    ...
                    >
                        ...
                        <Divider style={{ margin: '24px 0' }}><Text type="secondary" style={{ fontSize: '12px' }}>CURRENT PASSWORD</Text></Divider>
                        ...
                        <Divider style={{ margin: '24px 0' }}><Text type="secondary" style={{ fontSize: '12px' }}>NEW PASSWORD</Text></Divider>
