    ...
    return (
        ...
        >
            <Form form={form} layout="vertical" >
                <Row gutter={16}>
                    <Col xs={24} sm={12}> <AntdFormItem name="category" label="Category" type="select" rules={[{ required: true }]} options={categories} /> </Col>
                </Row>
                <Row gutter={16}>
                    <Col xs={24} sm={12}> <AntdFormItem name="amount" label="Amount" type="number" rules={[{ required: true }]} inputProps={{ prefix: "$" }} /> </Col>
                </Row>
                <Row gutter={16}>
                    <Col xs={24} sm={12}> <AntdFormItem name="dateOfExpense" label="Date of Expense" type="date" rules={[{ required: true }]} /> </Col>
                </Row>
                <Row gutter={16}>
                    <Col xs={24}>
