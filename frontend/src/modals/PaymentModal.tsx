    ...
    return (
        ...
        >
            ...
            >
                ...
                <Row gutter={16}>
                    <Col xs={24} sm={12}> <AntdFormItem name="feeType" label="Fee Type" type="select" rules={[{ required: true }]} options={feeTypes} /> </Col>
                    <Col xs={24} sm={12}> <AntdFormItem name="amount" label="Amount" type="number" rules={[{ required: true }]} inputProps={{ prefix: "$" }} /> </Col>
                </Row>
                ...
                <Row gutter={16}>
                    <Col xs={24} sm={12}> <AntdFormItem name="dateReceived" label="Date Received" type="date" rules={[{ required: true }]} /> </Col>
                    <Col xs={24} sm={12}> <AntdFormItem name="methodOfPayment" label="Payment Method" type="select" rules={[{ required: true }]} options={paymentMethods} /> </Col>
                </Row>
