package io.carizmi.domain.finance.model;
...
public class PaymentVO extends ValueObject {
    ...
    @NotBlank
    @Column(name = FieldConstants.FEE_TYPE, nullable = false, length = 3)
    ...
    @NotBlank
    @Column(name = FieldConstants.METHOD_OF_PAYMENT, nullable = false, length = 3)
