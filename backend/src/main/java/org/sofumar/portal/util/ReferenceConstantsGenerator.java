...
/**
 * Utility to generate ReferenceConstants.java from reference-data.json.
 * Run this main method to regenerate constants when the JSON definition
 * changes.
 */
public class ReferenceConstantsGenerator {
    private static final Logger logger = LoggerFactory.getLogger(ReferenceConstantsGenerator.class);

    private static final String RESOURCE_PATH = "src/main/resources/data/reference-data.json";
    private static final String OUTPUT_PATH = "src/main/java/org/sofumar/portal/constants/ReferenceConstants.java";
    ...
    public static void generate() throws IOException {
        ...
        sb.append(" * DO NOT MODIFY MANUALLY. Run ReferenceConstantsGenerator to regenerate.\n");
        sb.append(" */\n");
        sb.append("public final class ReferenceConstants {\n\n");
