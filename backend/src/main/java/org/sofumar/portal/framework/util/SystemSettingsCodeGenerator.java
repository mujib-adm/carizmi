...
/**
 * Utility to generate SystemSettingsCodeConstants.java from systemsettings-data.json.
 * Run this main method to regenerate constants when the JSON definition
 * changes.
 */
public class SystemSettingsCodeGenerator {
    private static final Logger logger = LoggerFactory.getLogger(SystemSettingsCodeGenerator.class);

    private static final String RESOURCE_PATH = "src/main/resources/systemsettings-data.json";
    private static final String OUTPUT_PATH = "src/main/java/org/sofumar/portal/constants/SystemSettingsCodeConstants.java";
    ...
    public static void generate() throws IOException {
        ...
        sb.append(" * DO NOT MODIFY MANUALLY. Run SystemSettingsCodeGenerator to regenerate.\n");
        sb.append(" */\n");
        sb.append("public final class SystemSettingsCodeConstants {\n\n");

        for (Map.Entry<String, JsonNode> field : rootNode.properties()) {
            String settingType = field.getKey();
            JsonNode values = field.getValue();

            String className = camelToSnake(settingType).toUpperCase();

            sb.append("    public static final class ").append(className).append(" {\n");
            sb.append("        public static final String TYPE = \"").append(settingType).append("\";\n");
